...
if TYPE_CHECKING:
    from word_tree.wave11_ancestry import Wave11Ancestry
...
class Layer6Handoff:
    ...
    الحكم النحوي المنتظَر من LAYER 6:
      • الفعل رفع فاعلاً
      • الفعل نصب مفعولاً
      • المبتدأ احتاج خبراً
      • الجار والمجرور متعلِّق
      • الصفة تابعة لموصوف
      • الإضافة أنشأت علاقة مضاف/مضاف إليه
    """
    root:           str
    synset_id:      str
    ...
    qayd:           tuple[str, ...]  # القيود (مفعول، جار، حال...)
...
class IfadahResult:
    ...
    musnad:           str = ""
    musnad_ilayh:     str = ""
    qayd:             list[str] = field(default_factory=list)
