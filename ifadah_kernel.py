...
from wave11_ancestry import Wave11Ancestry, wave11_build
from core.types import SemanticType
from ifadah_types import (
...
def _guard_musnad(musnad: str, block_reasons: list) -> bool:
...
def _guard_musnad_ilayh(musnad_ilayh: str, block_reasons: list) -> bool:
...
def _guard_fi3liyya_faail(
    fi3l: str, filled: list, block_reasons: list
) -> bool:
...
def _guard_ismiyya_mubtada_khabar(
    mubtada: str, khabar: str, block_reasons: list
) -> bool:
...
def _guard_wasfiyya_not_promoted(
    wasf: str, sentence_type: str, block_reasons: list
) -> bool:
